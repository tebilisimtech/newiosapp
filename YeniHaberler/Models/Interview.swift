...
// MARK: - Interview Detail Response (Single)
struct InterviewDetailResponse: Codable {
    let data: InterviewDetail
    let error: Bool
    let message: String?
}

// MARK: - Interview Model (List item)
...
// MARK: - Interview Detail Model (Full content)
struct InterviewDetail: Codable, Identifiable {
    let id: Int
    let name: String
    let slug: String?
    let url: String?
