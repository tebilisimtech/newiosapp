...
// MARK: - Biography Detail Response (Single)
struct BiographyDetailResponse: Codable {
    let data: BiographyDetail
    let error: Bool
    let message: String?
}

// MARK: - Biography Model (List item)
struct Biography: Codable, Identifiable {
    let id: Int
    let name: String
    let slug: String?
...
// MARK: - Biography Detail Model (Full content)
struct BiographyDetail: Codable, Identifiable {
    let id: Int
    let name: String
    let slug: String?
    let url: String?
